...
export const fetchRating = (serverUrl: string) => async (dispatch: Dispatch): Promise<AnyAction> => {
...
export const joinGame = (gameId: string) => (dispatch: Dispatch): AnyAction => {
...
export const closeGame = () => (dispatch: Dispatch): AnyAction => {
...
export const makeMove = ({ gameId, move }: { gameId: string; move: string }) => (dispatch: Dispatch): AnyAction => {
...
export const sendMessage = ({ gameId, message }: { gameId: string; message: string }) => (dispatch: Dispatch): void => {
...
export const refreshToken = (newToken: string) => (dispatch: Dispatch): AnyAction => {
...
export const removeError = (errorId: number) => (dispatch: Dispatch): AnyAction => {
  return dispatch({
...
export const removeNotification = (notificationId: number) => (dispatch: Dispatch): AnyAction => {
  return dispatch({
...
export const updateServerUrl = (serverUrl: string) => (dispatch: Dispatch): void => {
  dispatch({
...
export const reloadGames = (filterSettings: IFilterSettings) => (dispatch: Dispatch): void => {
  dispatch({
...
export const repeatGame = (gameId: string) => (dispatch: Dispatch): AnyAction => {
...
export const acceptInvite = (inviteId: string) => (dispatch: Dispatch): void => {
  socketService.acceptInvite(inviteId);
};

export const declineInvite = (inviteId: string) => (dispatch: Dispatch): void => {
  socketService.declineInvite(inviteId);
};

export const newInvite = ({ gameId, userId }: { gameId: string; userId: string }) => (dispatch: Dispatch): void => {
  socketService.newInvite({ gameId, userId });
};

export const updateRemovingGame = (removingGame: string) => (dispatch: Dispatch): void => {
  dispatch({
...
export const updateActiveGame = (invite: IInvite) => (dispatch: Dispatch): void => {
  dispatch({
    type: ActionTypes.UPDATE_REMOVING_GAME,
    invite,
  });
...
export const removeGameUser = (isConfirmed: boolean) => (dispatch: Dispatch, getState: () => IState): void => {
...
export const closeInvite = (isConfirmed: boolean) => (dispatch: Dispatch, getState: () => IState): void => {
